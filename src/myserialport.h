...
public:
    ...
    bool callTriggeredState = false;
    bool callActiveState = false;
    bool isTakingPic = false;

    

    QString frontRecordPath_sd = "/mnt/mydisk/frontRecord";
    QString frontRecordPath_flash = "/home/pi/frontCamRecordings";

    QString rearRecordPath_sd = "/mnt/mydisk/rearRecord";
    QString rearRecordPath_flash = "/home/pi/rearCamRecordings";

    QString frontPicturesPath_sd = "/mnt/mydisk/frontPictures";
    QString frontPicturesPath_flash = "/home/pi/frontCamPictures";
...
//    void killVideo(int vid);
    ...
    void sendDelayed(const QByteArray &s, int delay=2000);

    void setCurrentState(QString address, QString link);
    void checkCamWifi();
